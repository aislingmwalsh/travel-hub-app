            ...
            <div className="flex items-start gap-3 w-full sm:w-auto">
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  {item.paidInAdvance && !isEditing && <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2.5 py-0.5 rounded-full border border-emerald-200 flex items-center gap-1"><Check className="w-3 h-3" />Paid in advance</span>}
